...
// بيانات السؤال مع ملف الصوت المطلوب
const question = {
  title: "The Ice Giant",
  text: "Which planet spins on its side?",
  soundFile: "/soundQuetion/77.mp3", 
  options: [
    { id: "uranus", label: "Uranus", emoji: "🌀", isCorrect: true },
    { id: "mars", label: "Mars", emoji: "🔴", isCorrect: false },
    { id: "earth", label: "Earth", emoji: "🌍", isCorrect: false },
...
export default function UranusLevel({ onComplete, onBack }: UranusLevelProps) {
  ...
  const toggleOption = (id: string) => {
    ...
    // منطق اختيار واحد فقط لأن السؤال مفرد (Which planet...)
  ...
  const handleMainButton = () => {
    ...
    if (isCorrect) {
      ...
      if (selected.length === 0) {
        setFeedbackMessage("Please select a planet first.")
      } else {
        setFeedbackMessage("Oops! That's not the one.")
      }
    }
  }
    ...
    <div className="flex min-h-screen flex-col items-center justify-center p-4 relative overflow-hidden bg-slate-900">
      ...
      <div className="w-full max-w-5xl flex flex-col items-center z-10">
        ...
        <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} className="mb-8 flex flex-col items-center">
          <div className="mb-4 text-8xl inline-block animate-spin-slow" style={{ animationDuration: '10s' }}>
            ❄️
          </div>
        ...
        {showSuccessModal && (
          ...
          >
            <div className="text-center p-8">
              ...
              >
                Uranus is weird! It spins on its side!
              </motion.p>
